...
import { boxTokens, seperatorTokens, spacerTokens, textTokens } from './components.js'
...
export type ComponentTokens = TextTokens | BoxTokens | SeperatorTokens | SpacerTokens
