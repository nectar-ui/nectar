...
export interface BoxOwnProps {
  ...
  borderTopWidth?:
    | keyof typeof borderWidthTokens
  ...
  borderTopStyle?:
    | keyof typeof borderStyleTokens
...
/**
 * A box is a configurable container for your content.
 */
  ...
  (
    ...
    if (borderColor) {
      style['--box-border-top-color'] =
        borderColor in colorTokens
          ? `var(--colors-${borderColor})`
          : borderColor
    ...
    if (borderTopColor) {
      style['--box-border-top-color'] =
        borderTopColor in colorTokens
          ? `var(--colors-${borderTopColor})`
          : borderTopColor
    }
    if (borderBottomColor) {
      style['--box-border-bottom-color'] =
        borderBottomColor in colorTokens
          ? `var(--colors-${borderBottomColor})`
          : borderBottomColor
    }
    if (borderLeftColor) {
      style['--box-border-left-color'] =
        borderLeftColor in colorTokens
          ? `var(--colors-${borderLeftColor})`
          : borderLeftColor
    }
    if (borderRightColor) {
      style['--box-border-right-color'] =
        borderRightColor in colorTokens
          ? `var(--colors-${borderRightColor})`
          : borderRightColor
    }
    if (borderStyle) {
      style['--box-border-top-style'] =
        borderStyle in borderStyleTokens
          ? `var(--border-styles-${borderStyle})`
          : borderStyle
    ...
    if (borderWidth) {
      style['--box-border-top-width'] =
        borderWidth in borderWidthTokens
          ? `var(--border-widths-${borderWidth})`
          : borderWidth
    ...
    if (radii) {
      style['--box-radii-top-left'] =
        radii in radiiTokens ? `var(--radii-${radii})` : radii
    ...
    if (radiiTopLeft) {
      style['--box-radii-top-left'] =
        radiiTopLeft in radiiTokens
          ? `var(--radii-${radiiTopLeft})`
          : radiiTopLeft
    }
    if (radiiTopRight) {
      style['--box-radii-top-right'] =
        radiiTopRight in radiiTokens
          ? `var(--radii-${radiiTopRight})`
          : radiiTopRight
    }
    if (radiiBottomLeft) {
      style['--box-radii-bottom-left'] =
        radiiBottomLeft in radiiTokens
          ? `var(--radii-${radiiBottomLeft})`
          : radiiBottomLeft
    }
    if (radiiBottomRight) {
      style['--box-radii-bottom-right'] =
        radiiBottomRight in radiiTokens
          ? `var(--radii-${radiiBottomRight})`
          : radiiBottomRight
    }
    if (shadow) {
      style['--box-shadow'] =
        shadow in shadowTokens ? `var(--shadows-${shadow})` : shadow
    }

    if (minHeight) {
      style['minHeight'] =
        minHeight in sizingTokens ? `var(--sizings-${minHeight})` : minHeight
    }
    if (minWidth) {
      style['minWidth'] =
        minWidth in sizingTokens ? `var(--sizings-${minWidth})` : minWidth
    }
    if (maxWidth) {
      style['maxWidth'] =
        maxWidth in sizingTokens ? `var(--sizings-${maxWidth})` : maxWidth
    }
    if (width) {
    ...
    if (padding) {
      style['--box-padding-top'] =
        padding in spacingTokens ? `var(--spacings-${padding})` : padding
    ...
    if (paddingTop) {
      style['--box-padding-top'] =
        paddingTop in spacingTokens
          ? `var(--spacings-${paddingTop})`
          : paddingTop
    }
    if (paddingLeft) {
      style['--box-padding-left'] =
        paddingLeft in spacingTokens
          ? `var(--spacings-${paddingLeft})`
          : paddingLeft
    }
    if (paddingRight) {
      style['--box-padding-right'] =
        paddingRight in spacingTokens
          ? `var(--spacings-${paddingRight})`
          : paddingRight
    }
    if (paddingBottom) {
      style['--box-padding-bottom'] =
        paddingBottom in spacingTokens
          ? `var(--spacings-${paddingBottom})`
          : paddingBottom
    }
    if (paddingX) {
      style['--box-padding-left'] =
    ...
    if (bottom) {
      style['bottom'] =
        bottom in sizingTokens ? `var(--sizings-${bottom})` : bottom
    }
    if (left) {
    ...
    if (zIndex) {
      style['--box-z-index'] =
        zIndex in zIndiceTokens ? `var(--z-indices-${zIndex})` : zIndex
    }
